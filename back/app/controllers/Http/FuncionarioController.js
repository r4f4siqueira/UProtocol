...
class FuncionarioController {
  async criarFuncionario({ request, response }) {
    ...
    if (
      ...
      // Database.close(['pg'])
      return {
        erro: { codigo: 18, msg: "UID inválida para criar funcionario" },
      };
    } else {
      if (
        dataToCreate.nome === "" ||
        ...
        // Database.close(['pg'])
        return {
          erro: { codigo: 19, msg: "Nome invalido para criar funcionario" },
        };
      } else {
        if (
          dataToCreate.email === "" ||
          ...
          // Database.close(['pg'])
          return {
            erro: { codigo: 20, msg: "Email invalido para criar funcionario" },
          };
        } else {
