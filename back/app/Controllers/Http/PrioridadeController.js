    ...
    async criarPrioridade({ request, response }) {
        ...
        if (userc.length === 0) {
            ...
            retorno = {
                erro: {
                    codigo: 85,
                    msg: "Funcionario não vinculado a empresa para criar Prioridade",
                },
            };
        } else {
            if (userc[0]?.cargo === "F") {
                ...
                retorno = {
                    erro: {
                        codigo: 86,
                        msg: "Funcionário sem permissão para Criar prioridade",
                    },
                };
            } else {
                if (
                    ...
                    retorno = {
                        erro: {
                            codigo: 87,
                            msg: "Nome ou Ordem de Importância inválidos",
                        },
                    };
                } else {
    ...
    async listarPrioridades({ request, response }) {
        ...
        if (user.length === 0) {
            ...
            retorno = {
                erro: {
                    codigo: 88,
                    msg: "funcionario não vinculado a empresa para listar prioridades",
                },
            };
        } else {
    ...
    async alterarPrioridade({ params, request, response }) {
        ...
        if (!prioridade) {
            ...
            retorno = {
                erro: {
                    codigo: 89,
                    msg: "Prioridade não encontrada para ser alterada",
                },
            };
        } else {
            const dadosRequest = request.only([
            ...
            if (userm.length === 0) {
                ...
                retorno = {
                    erro: {
                        codigo: 90,
                        msg: "Funcionario não vinculado a empresa para alterar Prioridade",
                    },
                };
            } else {
                if (userm[0]?.cargo === "F") {
                    ...
                    retorno = {
                        erro: {
                            codigo: 91,
                            msg: "Funcionário sem permissão para alterar prioridade",
                        },
                    };
                } else {
                    await logC.novoLog({
    ...
    async deletarPrioridade({ params, request, response }) {
        ...
        if (!prioridade) {
            ...
            retorno = {
                erro: {
                    codigo: 92,
                    msg: "Prioridade não encontrada para ser deletada",
                },
            };
        } else {
            const dadosRequest = request.only(["uid", "empresa"]);
            ...
            if (user.length === 0) {
                ...
                retorno = {
                    erro: {
                        codigo: 93,
                        msg: "Funcionario não vinculado a empresa para deletar Prioridade",
                    },
                };
            } else {
                if (user[0]?.cargo === "F") {
                    ...
                    retorno = {
                        erro: {
                            codigo: 94,
                            msg: "Funcionário sem permissão para deletar prioridade",
                        },
                    };
                } else {
                    retorno = prioridade;
