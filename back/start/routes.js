...
Route.get('/',()=>{return { Erro: 'Api FUNCIONA!!!' }})//desativar esta rota assim que possivel
...
Route.get('/usuarioempresa','UsuarioEmpresaController.listarUsuarioEmpresas')
Route.get('/usuarioempresa/:id','UsuarioEmpresaController.dadosUsuarioEmpresa')
...
Route.post('/usuarioempresa', 'UsuarioEmpresaController.criarUsuarioEmpresa')
...
Route.put('/usuario/:id','UsuarioController.alterarUsuario')
Route.put('/usuarioempresa/:id','UsuarioEmpresaController.alterarUsuarioEmpresa')
...
Route.delete('/usuarioempresa/:id','ClienteController.deletarCliente')
