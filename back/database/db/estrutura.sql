...
CREATE TABLE EMPRESA (
    ...
    DATAM TIMESTAMP,
    USERM INT
    CONSTRAINT FK_EMPRESA_USUARIO FOREIGN KEY (CRIADOR) REFERENCES USUARIO(ID),
    );
...
CREATE TABLE REPASSE (
    ...
    CONSTRAINT FK_USUARIO_REPASSE FOREIGN KEY (USUARIOATUAL) REFERENCES USUARIO (ID),
    CONSTRAINT FK_USUARIO_REPASSE FOREIGN KEY (USUARIODESTINO) REFERENCES USUARIO (ID)
);
